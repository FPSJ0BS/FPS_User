  ...
  return (
    <div className="flex w-full justify-center items-center bg-black py-3 rounded-lg px-4">
      <div className="relative flex items-center w-full lg:w-[60%]">
        ...
        />
        <button className=" font-semibold text-[14px] md:text-[16px]  border-0 shadow-lg absolute right-0 top-1/2 transform -translate-y-1/2 bg-[#c94f56] text-white px-3  md:w-[30%] h-[100%] rounded-[30px] hover:bg-blue-600">
          Search Jobs
        </button>
      </div>

      <div className="  lg:flex justify-end gap-2 items-center hidden w-[40%]">
        <svg
