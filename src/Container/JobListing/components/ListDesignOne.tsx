...
const ListDesignOne = ({
  ...
  return (
    <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-1 gap-4 cursor-pointer place-items-center sm:place-items-stretch  ">
      {jobsData?.map((item, index) => {
        ...
        return (
          <div
            ...
            key={index}
            className=" w-[90vw] sm:w-[44vw] md:w-[28vw] lg:w-[78vw] gap-2 min-h-[280px] 2xl:min-h-[250px]  bg-white rounded-[20px] p-[10px] flex flex-col items-start justify-start shadow-md border-1 border-solid border-[#e1e1df]"
          >
                ...
                <div className=" flex  justify-between w-full">
                  <div className=" flex w-[85%] gap-4  items-center">
                    <div className=" flex flex-col  ">
                      ...
                      <h2 className="text-black font-bold mb-0 text-[17px] 2xl:text-[18px] uppercase leading-[1.4em] break-all">
                        {item?.job_title}
                      </h2>

                      {data?.data?.pack_type === "Prepaid" &&
                      userData?.UID !== undefined ? (
                        <h2 className="text-semibold font-bold mb-0 text-[15px] uppercase leading-[1.4em] line-clamp-1 ">
                          {item?.company_name}
                        </h2>
                      ) : item?.show_all === 1 ? (
                        <h2 className="text-semibold font-bold mb-0 text-[15px] uppercase leading-[1.4em] line-clamp-1 ">
