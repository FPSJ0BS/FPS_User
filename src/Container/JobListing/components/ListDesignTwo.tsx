...
const ListDesignTwo = ({
  ...
  return (
    <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2   gap-4  ml-3 cursor-pointer place-items-center sm:place-items-stretch  ">
      {jobsData?.map((item, index) => {
        ...
        return (
          <div
            ...
            key={index}
            className=" w-[90vw] sm:w-[44vw] md:w-[28vw] lg:w-[38vw] gap-2 min-h-[280px]  bg-white rounded-[20px] p-[10px] flex flex-col items-start justify-start shadow-md border-1 border-solid border-[#e1e1df]"
          >
              ...
              <div className=" flex flex-col gap-3 w-full">
                ...
                <div className=" flex flex-row-reverse justify-between w-full items-center">
                  ...
                  <div className=" flex flex-col  w-[75%]">
                    <h2 className="text-black font-bold mb-0 text-[17px] uppercase leading-[1.4em] break-all">
                      {item?.job_title}
                    </h2>

                    {data?.data?.pack_type === "Prepaid" &&
                    userData?.UID !== undefined ? (
                      <h2 className="text-semibold font-bold mb-0 text-[14px] uppercase leading-[1.4em] line-clamp-2">
                        {item?.company_name}
                      </h2>
                    ) : item?.show_all === 1 ? (
                      <h2 className="text-semibold font-bold mb-0 text-[14px] uppercase leading-[1.4em] line-clamp-2">
                ...
                <div>
                  <p className=" mb-0 line-clamp-3 font-medium text-[13px]">
            ...
            <div className=" w-full flex justify-between items-center pt-2">
              ...
              <div className=" bg-black flex justify-center items-center text-[13px] text-white rounded-[30px] px-3 h-[25px] ">
                Details
              </div>
            </div>
            ...
            <div className="  flex w-full  justify-between items-center ">
              ...
              <div className=" flex justify-center items-center gap-1">
                ...
                <div className="flex gap-[0.5px]">
                  <img className="w-[13px]" src={STAR} alt="star" />
                  <img className="w-[13px]" src={STAR} alt="star" />
                  <img className="w-[13px]" src={STAR} alt="star" />
                  <img className="w-[13px]" src={STAR} alt="star" />
                  <img className="w-[13px]" src={HALFSTAR} alt="star" />
                </div>
              </div>
            </div>
          </div>
