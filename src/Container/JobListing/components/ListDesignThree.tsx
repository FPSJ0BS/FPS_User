...
const ListDesignThree = ({jobsData, data, setJobFavourite, setRemoveFavourite, getRelativeTime, handleOpenInNewTab,Category,colors}) => {
                ...
                <div className={`  h-[75%] rounded-2xl ${bgColor} p-[10px] w-full`}>
                  <div className=" flex flex-col gap-3 w-full">
                    ...
                    <div className=" flex flex-col w-full">
                      ...
                      {data?.data?.pack_type === "Prepaid" && userData?.UID !== undefined ? (
