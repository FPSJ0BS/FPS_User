  ...
  return (
    <div className="bg-white rounded-[20px]  p-[20px] min-h-[200px] w-full">
       <div className=" flex justify-between items-center gap-2  ">
        ...
        <div className=" cursor-pointer text-[#81b29a] font-semibold hover:bg-[#81b29a] hover:text-white px-3 py-1 border-[2px] border-solid  rounded-3xl flex justify-center items-center">Add Employment</div>
