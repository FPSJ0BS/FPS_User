...
import { closeModalEducationDeleteModal, closeModalEmploymentDeleteModal, toggleRefetchProfile } from "@/Redux/Dashboard/MyProfile/Education/EducationSlice";
import { getDeleteEducationDetails, getDeleteEmploymentDetails } from "@/api/api";
import { Toast } from "@Utils/Toast";

function EmploymentDeletePopup() {
  ...
  const onSubmitData = async () => {
    setButtonLoad(true);
    try {
      const res = await getDeleteEmploymentDetails(
  ...
  const popupCloseFunc = async () => {
    await dispatch(closeModalEmploymentDeleteModal());
  };
...
export default EmploymentDeletePopup;
