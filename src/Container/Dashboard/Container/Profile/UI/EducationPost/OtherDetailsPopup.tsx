...
import { closeModalOtherDetailsModal, toggleRefetchProfile } from "@/Redux/Dashboard/MyProfile/Education/EducationSlice";
...
function OtherDetailsPopup() {
    ...
    const { userDataArray } = useSelector((state: any) => state.myProfileEducationSlice);
        ...
        <div className="TrackPopup h-full w-[65vw] right-0 z-50 flex justify-end fixed">
            ...
            <div className="bg-white h-full w-[90%] rounded-l-[100px] shadow-lg flex flex-col items-center py-4">
                ...
                <div className="h-[85%] w-[90%] border-1 border-solid border-gray-200 p-3 rounded-xl overflow-y-auto handleScrollbarMain mt-[30px]">
                    <form onSubmit={handleSubmit} className=" p-6 rounded  grid grid-cols-2 gap-4">
                        
                        <div className="">
                            <label className="block text-sm font-semibold text-black" htmlFor="address">Address</label>
                            <input
                            required
                        ...
                        <div className="">
                            <label className="block text-sm font-semibold text-black" htmlFor="hometown">Hometown</label>
                            <input
                            required
                                className="w-[100%] mb-2 p-2 border-[1px] focus:border-[2px] border-gray-300 rounded-md shadow-sm focus:outline-none border-solid focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                type="text"
                        ...
                        <div className="">
                            <label className="block text-sm font-semibold text-black" htmlFor="pincode">Pincode</label>
                            <input
                            required
                                className="w-[100%] mb-2 p-2 border-[1px] focus:border-[2px] border-gray-300 rounded-md shadow-sm focus:outline-none border-solid focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                type="number"
                        ...
                        <div className="">
                            <label className="block text-sm font-semibold text-black" htmlFor="gender">Gender</label>
                            <select
                            required
                                className="w-[100%] mb-2 p-2 border-[1px] focus:border-[2px] border-gray-300 rounded-md shadow-sm focus:outline-none border-solid focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                id="gender"
                        ...
                        <div className="">
                            <label className="block text-sm font-semibold text-black" htmlFor="dob">Date of Birth</label>
                            <input
                            required
                                className="w-[100%] mb-2 p-2 border-[1px] focus:border-[2px] border-gray-300 rounded-md shadow-sm focus:outline-none border-solid focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                type="date"
                        ...
                        <div className="">
                            <label className="block text-sm font-semibold text-black" htmlFor="banner">Banner</label>
                            <input
                        ...
                        <div className=" col-span-2">
                            <label className="block text-sm font-semibold text-black" htmlFor="bio">Bio</label>
                            <textarea
                            required
                                className="w-[100%] mb-2 p-2 border-[1px] focus:border-[2px] border-gray-300 rounded-md shadow-sm focus:outline-none border-solid focus:border-indigo-500 focus:ring focus:ring-indigo-500 focus:ring-opacity-50"
                                id="bio"
