...
const ContactUs = () => {
  ...
  const onSubmit: SubmitHandler<IContactUs> = (data) => {
    const _data = { ...data, UID: userData?.UID ? userData?.UID : 103082 };
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="group-contact-us">
                <div className="infor-contact-v1">
                  ...
                  <div className="icon-inforr">
                    ...
                    <div className="content">
                      ...
                      <NavLink
                        to={`mailto:${AppConst.EmailSecond}`}
                        className="d-block"
                        target="_blank"
                      >
                        {AppConst.EmailSecond}
                      </NavLink>
                      <NavLink
                ...
                <div className="form-candidate col-lg-6">
                  <form>
