...
import review from "@Assets/images/review/thumb-review.png";
...
import user4 from "@Assets/images/review/user4.jpg";
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12 content-tab wow fadeInRight">
            <div className="wd-review-job contentbox1">
              ...
              <p>
                Search thousand of jobs and get the inside scoop on companies
              ...
              <ul className="wd-list-icon">
                <li className="d-flex align-items-center">
                  ...
                  <div>
                    {" "}
                    Find Your Perfect Job Explore Opportunities on,{" "}
                    <a
                      href={"https://fpsjob.com/"}
                      style={{ color: "#a73358" }}
                    >
                      FPSJOB.com
                    </a>
                ...
                <li className="d-flex align-items-center">
                  ...
                  Unlock Your Career Potential: Discover Jobs Tailored to You.
                </li>
                <li className="d-flex align-items-center">
                  <span className="icon">
                    <svg
                  ...
                  Seamless Job Hunting: Navigate Opportunities with Ease
                </li>
                <li className="d-flex align-items-center">
                  <span className="icon">
                    <svg
                  ...
                  Personalized Job Alerts: Stay Ahead of the Curve
                </li>
                <li className="d-flex align-items-center">
                  <span className="icon">
                    <svg
                  ...
                  Verified Job Listings: Trust and Authenticity Guaranteed
                </li>
                <li className="d-flex align-items-center">
                  <span className="icon">
                    <svg
                  ...
                  Empowering Your Career: Resources and Guidance at Your
                  Fingertip
                </li>
                <li className="d-flex align-items-center">
                  <span className="icon">
                  ...
                  Fair and Transparent Recruitment: Your Trust Is Our Priority
                </li>
                <li className="d-flex align-items-center">
                  <span className="icon">
                    <svg
                  ...
                  24/7 Support: Your Partner in Career Succes
                </li>
                <li className="d-flex align-items-center">
                  <span className="icon">
                    <svg
                  ...
                  Join Our Community: Connect, Network, Thrive
                </li>
                ...
                {/* <li className="d-flex align-items-center">
                  ...
                  <NavLink
                    to={"https://fpsjob.com/"}
                    style={{ color: "#a73358",display:"inline" }}
                  >
                    FPSJOB.com's
                  </NavLink>{" "}
